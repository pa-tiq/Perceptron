...
class Perceptron:
    ...
    def __init__(self, amostras_n, saidas, taxa_aprendizado=0.001, epocas=1000, limiar=-0.8649, pesos=[0.3092, 0.3129]):
...
for j in range (len(saidas[0])):
    ...
    redeA = Adaline(amostras_n, saidas_rede)
    rede.treinar()
    redeA.treinar()
